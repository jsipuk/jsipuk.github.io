/* The Dojo service worker.
 *
 * Precache everything on install and serve cache-first, so a rep works on a
 * plane, in a lift, or on a train through a tunnel. There is no runtime network
