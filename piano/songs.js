...
const DEMO_SONGS = [
  ...
  {
    title: 'She\'s a Rainbow (Rolling Stones)',
    bpm: 90,
    beatsPerBar: 4,
    notes: seq('R', [
      [null, 0.5], [F4, 0.5, 1], [F4, 0.5, 1], [F4, 0.5, 1], [G4, 0.5, 2],
      [Ab4, 0.5, 3], [Ab4, 0.5, 3], [G4, 0.5, 2], [F4, 0.5, 1],
      [G4, 0.5, 2], [Ab4, 0.5, 3], [Bb4, 0.5, 4], [Bb4, 0.5, 4],
      [Ab4, 0.5, 3], [G4, 0.5, 2], [F4, 0.5, 1], [Eb4, 0.5, 3],
      [F4, 0.5, 1], [G4, 0.5, 2], [Ab4, 0.5, 3], [Bb4, 1, 4],
      [null, 0.5], [Ab4, 0.5, 3], [Ab4, 0.5, 3], [Bb4, 0.5, 4],
      [Bb4, 0.5, 4], [Ab4, 0.5, 3], [G4, 0.5, 2], [F4, 1, 1],
      [null, 0.5], [F4, 0.5, 1], [F4, 0.5, 1], [G4, 0.5, 2],
      [Ab4, 0.5, 3], [Ab4, 0.5, 3], [G4, 0.5, 2], [F4, 1, 1],
    ]),
  },
];
