/* Account Brain — storage and encryption layer.
 *
 ...
 * files so it works offline, and a service worker only intercepts requests
 * inside its own scope, so a shared /lib/ copy would silently break offline for
 ...
 * same file runs in the browser and under Node for `node account-brain/test/run.js`.
